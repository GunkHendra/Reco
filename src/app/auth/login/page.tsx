  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center min-h-screen px-4 pt-20 pb-4">
        <div className="w-full md:max-w-md md:rounded-2xl md:bg-card/20 md:shadow-lg md:border md:p-8 flex flex-col items-center gap-2 lg:gap-4">
          ...
          <form className="w-full flex flex-col gap-4">
            ...
            <Button
              type="submit"
              className="w-full px-4 py-2 rounded-md lg:text-lg"
            >
              Login
            </Button>
          </form>
